...
### Rule 3: 四层自检不能合并（卡兹克四层体系）

**必须分别完成，四层全通过才算达标**:
1. **L1 硬性规则**：删禁用词（"说白了/本质上/换句话说"等）、改禁用标点（冒号/破折号→逗号，双引号→「」）、去套话、叙述类文章无 bullet point
2. **L2 节奏与口语化**：开头从具体事件切入（非宏大叙事）、口语转场词（"坦率的讲/说真的/反正我觉得"）、长句拆分、人称主语
3. **L3 内容质量**：事实准确、逻辑链条完整、至少 2 个真实案例、至少 1 个具体数据
4. **L4 活人感**（最终关卡）：
   - **温度感**：有自嘲/脆弱/亲身下场细节，读者感受到真实的人
   - **独特性**：这个角度/经历只有你能写，换人写出一模一样则独特性为零
   - **姿态**：参与者而非评论员，亲自做了那件事而非隔空点评
   - **心流**：前面埋的细节后面有呼应，读者能从头读到尾不中断

**❌ 不能**:
- 一遍审校就完成所有检查
- 跳过 L4 活人感（这是最容易被忽略的关卡）
- 只做风格审校，不做内容审校
